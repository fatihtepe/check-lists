...
SC1133	Unexpected start of line. If breaking lines,
...
SC2024	sudo doesn’t affect redirects. Use `..
...
SC2036	If you wanted to assign the output of the pipeline, use a=$(b
